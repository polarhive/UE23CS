...
- Construct static models, use cases and class models, followed by analyzing the dynamics of the system using activity, sequence, state and process models.
- Depict the architecture of a software system by using component and deployment models • Use the concepts of classes and objects of object-oriented programming in Java to model a complex system.
